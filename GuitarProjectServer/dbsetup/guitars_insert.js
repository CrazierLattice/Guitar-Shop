...
const insert_guitars_toDB = async () => {
  ...
  const electric_two = new guitarModel({
    ...
    category: electric_category._id,
    price: "3200",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/RGIX7FDLB_NLB_1(1).png"
  })
  const electric_three = new guitarModel({
    name: "Pro-Mod San Dimas Style 2 HH FR M Ash",
    category: electric_category._id,
    price: "4000",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/130799-Pro-Mod-San-Dimas-ash(1).jpg"
  })
  const electric_four = new guitarModel({
    name: "Fender Player Jaguar Sonic Red",
    category: electric_category._id,
    price: "5321",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/0146303525_gtr_frt_001_rr(1).jpg"
  })
  //Acoustic Guitars
  ...
  const acoustic_four = new guitarModel({
    ...
    category: acoustic_category._id,
    price: "2000",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/0970743009_gtr_frt_001_rr(1).jpg",
  });
  ...
  const classic_one = new guitarModel({
    ...
    price: "350",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/20161012101844156(1).jpg",
  });
  const classic_two = new guitarModel({
    name: "Alhambra - 3/4 Cadete 1 Open",
    category: classic_category._id,
    price: "2000",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/ALHAMBRA_4P_-CLASSICAL_GUITAR_CADET(1).jpg",
  });
  ...
  const classic_four = new guitarModel({
    ...
    category: classic_category._id,
    price: "2400",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/ALHAMBRA_MOD.1C(1).jpg",
  });
  ...
  const bass_one = new guitarModel({
    ...
    price: "6900",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/0197002706_gtr_frt_001_rr(1).jpg",
  });
  ...
  const bass_three = new guitarModel({
    ...
    category: bass_category._id,
    price: "7100",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/2414-57-370_front(1).jpg",
  });
  const bass_four = new guitarModel({
    name: "Fender American Original '60s Jazz Bass",
    category: bass_category._id,
    price: "8200",
    picture: "https://www.kley-zemer.co.il/Media/Uploads/0190130809_gtr_frt_001_rr(1).jpg",
  });
